    ...
    return {
        ...
        run:
            ...
            `),
                        ...
                        user(
                            `Here is all the work done so far by other agents:`,
                        ),
                        ...getSteps(messages),
                    ...
                    response_format: {
                        step: z.object({
                            ...
                            reasoning: z
                                .string()
                                .describe(
                                    "The reasoning for performing this step.",
                                ),
              ...
              `),
                            has_next_step: z
                                .boolean()
                                .describe(
                                    "True if you provided next_step. False otherwise.",
                                ),
                        }),
                        error: z.object({
                            reasoning: z
                                .string()
                                .describe(
                                    "The reason why you cannot complete the task",
                                ),
                        }),
                    },
                });
