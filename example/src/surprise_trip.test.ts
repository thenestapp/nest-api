...
const testResults = await testwork(
    ...
    suite({
        ...
        team: {
            landmarkScout: [
                test("0_wikipedia", 'Should use "lookupWikipedia" tool'),
            ],
        },
        workflow: [
            test(
            ...
            test(
                "3_landmarkScout",
                'Should use "landmarkScout" to "Research landmarks of Wrocław"',
            ),
            test(
                "5_itineraryCompiler",
            ...
            test(
                "6_finalOutput",
                "Should return a 7 days itinerary as a final output",
            ),
            test(
                "7_snapshot",
